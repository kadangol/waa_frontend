...
import { getUnApprovedSellers, postApproveSeller, postRejectSeller } from '../actions/users'
import '../styling/checkout.css'

function Sellers({ unapprovedSellerList, fetchCartItems, saveApproveSeller, saveRejectSeller }) {
    React.useEffect(() => {
        fetchCartItems()
    }, [])
