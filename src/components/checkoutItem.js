    ...
    <div className="checkout-item">
      <div>
        <div className="item-image">
          <img
            src={
              item.image ||
              "https://m.media-amazon.com/images/I/714bAHH6LrL._AC_UY218_.jpg"
            }
            alt="itemImage"
          />
        </div>
      ...
      <div className="item-details">
        ...
        <div className="item-detail seller">
          <p>
            by <a href="#">{item.product.seller.user.username || "Seller"}</a>
          </p>
        </div>
        ...
        <div className="item-buttons">
          ...
          <div className="item-detail place-order-button">
            <button onClick={() => handlePlaceOrderItem(item.id)}>
              Place Order
            </button>
          </div>
        </div>
