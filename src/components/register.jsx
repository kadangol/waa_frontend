        ...
        {status === "buyer" && (
          <div>
            ...
            <input
              type="text"
              onChange={(e) =>
                handleShippingAdrressChange(e.target.value, "city")
              }
            />
            <h5>State</h5>
            <input
              type="text"
              onChange={(e) =>
                handleShippingAdrressChange(e.target.value, "state")
              }
            />
            <h5>Street</h5>
            <input
              type="text"
              onChange={(e) =>
                handleShippingAdrressChange(e.target.value, "street")
              }
            />
            <h5>Zipcode</h5>
            <input
              type="text"
              onChange={(e) =>
                handleShippingAdrressChange(+e.target.value, "zipcode")
              }
            />
          </div>
        )}
